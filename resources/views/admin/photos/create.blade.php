...
<div class="container" style="min-height: 500px">
        ...
        <div class="row">
            <div class="col-md-6">
            <form action="/admin/articles/{{$article_id}}/photos" method="POST" id="photos-form" enctype="multipart/form-data">
                {{csrf_field()}}
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                            ...
                            <a href="{{route('admin.articles.index')}}" class="btn btn-dark float-left">التالي</a>
